...
public class ManageMembershipCreateMembershipGUIController  implements SetInfoListViewInterface, MembershipConfirmPopupInterface, CouponConfirmationInterface, BuyPopUpInterface {
    ...
    List<CuponsBean> selectedCoupons;
    @FXML
    ...
    public void setInfo(Object bean) {
        try {
            if(bean instanceof CuponsBean temp) CouponConfirmationPopup.getPopup(this,temp,"CouponConfirmPopup.fxml","athlete",1);
    ...
    @Override
    public void confermaCuoponPopup(CuponsBean bean) {
