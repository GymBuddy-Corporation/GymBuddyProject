...
public class ViewYourAthletesGUIController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        List<String> lista = new ArrayList<>(Arrays.asList("Luca Martorelli", "Matteo Martorelli", "Marco Martorelli", "Alexandru Nazare", "Alessandro Lori", "Alessandro Cortese", "Giulia Boccuccia", "Andrea De Filippis"));
